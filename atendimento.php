        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                ...
                <div class="dropdown-content ">
                    ...
                    <a href="person_ser.php">ATENDIMENTO PRESSONALIZADO</a>
                </div>
                </div>
            </div>
        </nav>
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title text-center">Registar Serviço de Lavagem</div>
                                        <?php
                                            if(isset($_POST['serv'])){
                                                $nome = $_POST['nome'];
                                                $bairro = $_POST['bairro'];
                                                ...
                                                try {
                                                    $comando = "INSERT INTO `services` (`nome`, `bairro`, `casa`,`servico`,`bi`, `email`, `telefone`) VALUE (?, ?, ?, ?, ?, ?, ?) ";
                                                    $query = $conn->prepare($comando);
                                                    $query->execute(array($nome, $bairro, $casa, $servico,$bi, $email, $telefone));
                                        ?>
                                    ...
                                    <div class="card-body">
                                        <form action="" method="post">
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6">
                                                ...
                                                <input type="text" maxlength="500" minlength="3" name="bairro" id="" class="form-control shadow-none border">
                                            </div>
                                        </div>
                                            <div class="form-group">
                                                <label for="">Numero da casa</label>
                                                <input type="text" maxlength="500" minlength="2" name="casa" id="" class="form-control shadow-none border">
                                            </div>
                                            <div class="form-group">
                                                <label for="">TIPO DE SERVIÇO</label>
                                                <select name="servico" required id="" class="form-control shadow-none border">
                                                    <option value="" selected disabled>SELECIONAR</option>
                                                    <option value="Pintura">Pintura</option>
                                                    <option value="Manunteção">Manunteção</option>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12 col-md-6 col-lg-6">
                                                    <label for="">B.I</label>
                                                    <input type="text" name="bi" maxlength="250" minlength="3" id="" class="form-control shadow-none border">
                                                </div>
                                                <div class="col-sm-12 col-md-6 col-lg-6">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="serv" class="btn-info btn-block btn bg-warning shadow-none border">Registar</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
