                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title text-center">Registar Pintura</div>
                                        <?php
                                            if(isset($_POST['reg_pint'])){
                                                $nome = $_POST['nome'];
                                                ...
                                                try {
                                                    $comando = "INSERT INTO `pintura` (`nome`, `matricula`, `pintura`,`endereco`, `email`, `telefone`) VALUE (?, ?, ?, ?, ?, ?) ";
                                                    $query = $conn->prepare($comando);
                                                    $query->execute(array($nome, $matricula, $pintura, $endereco, $email, $telefone));
                                        ?>
                                        <div class="sufee-alert alert with-close alert-primary alert-dismissible fade show">
											Serviço de pintura registrada com sucesso
                                    ...
                                    <div class="card-body">
                                        <form action="" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="pintura" required id="" class="form-control shadow-none border">
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="reg_pint" class="btn-info btn-block btn bg-warning shadow-none border">Registar</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
