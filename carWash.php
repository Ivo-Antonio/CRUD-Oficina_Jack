                                    ...
                                    <div class="card-header">
                                        ...
                                        <?php
                                            if(isset($_POST['wash'])){
                                                ...
                                                try {
                                                    $comando = "INSERT INTO `wash` (`nome`, `matricula`, `wash`,`endereco`, `email`, `telefone`) VALUE (?, ?, ?, ?, ?, ?) ";
                                                    $query = $conn->prepare($comando);
                                                    $query->execute(array($nome, $matricula, $wash, $endereco, $email, $telefone));
                                        ?>
                                        <div class="sufee-alert alert with-close alert-primary alert-dismissible fade show">
											Usuário Adicionado fila de Lavagem 
                                    ...
                                    <div class="card-body">
                                        <form action="" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="wash" required id="" class="form-control shadow-none border">
                                                    <option value="" selected disabled>SELECIONAR</option>
                                                    <option value="Limpeza Geral">Limpeza Geral</option>
                                                    <option value="Limpeza Parcial_1">Limpeza Parcial_1</option>
                                                    <option value="Limpeza Parcial_2">Limpeza Parcial_2</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <button type="submit" name="wash" class="btn-info btn-block btn bg-warning shadow-none border">Registar</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
